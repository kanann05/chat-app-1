...
export default function Login() {
    ...
    return(<div className = "login">
        ...
        <Button className = "w-[30vw] 2xl:w-[5vw] xl:w-[7vw] lg:w-[7vw], sm:w-[10vw]" style = {{color : "rgba(255, 255, 255, 0.9)", backgroundColor : "rgba(255, 255, 255, 0.21)"}}>Log in</Button>
        <h2 onClick = {() => {router.replace("/signup")}} style = {{cursor : "pointer", color : "white", fontSize : '15px'}}>Sign up</h2>
    </div>) 
}